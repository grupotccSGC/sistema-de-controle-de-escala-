...
<div class="container-fluid">
    <div class="row">
        ...
        </span> Cadastro da Operações </h1></div>
    </div>
...
<div class="row">
      ...
      <?php if(!empty($da)){
          echo form_open('Welcome/atualizar_op');
        }else{
          echo form_open('Welcome/cadastro_op');
        } ?>
   ...
   <div class="form-group">
     <label for="exampleInputEmail1">Descrição da Operação  <font color="red"><b>*</b></font></label>
    <input type="text" name="operacao" class="form-control" required  value="<?php if(!empty($da)){echo $da->descricao;}?> <?php echo set_value('operacao'); ?>">
  </div>
</div>
      </div>  
      ...
      <div class="row">
        ...
        <div class="col-md-10">
   <div class="form-group">
     <label for="exampleInputEmail1">Status da operação <font color="red"><b>*</b></font></label>
    <input type="text" name="status" class="form-control"  id= "cpf"value="<?php if(!empty($da)){echo $da->status;}?> <?php echo set_value('status'); ?>" required>
  </div>
</div>   
