...
<div class="container-fluid">
    <div class="row">
        <div class=" col-md-12"> <h1 class="lead text-center" ><span class="glyphicon glyphicon-th" aria-hidden="true"></span> Cadastro da Empresa </h1></div>
...
<div class="col-md-6">
    <p> <?php 
      ...
      <?php if(!empty($da)){
          echo form_open('Welcome/atualizar');
        }else{
          echo form_open('Welcome/cadastro');
        } ?>
   ...
   <div class="form-group">
     <label for="exampleInputEmail1">Nome da Empresa  <font color="red"><b>*</b></font></label>
    <input type="text" name="empresa" class="form-control" required  value="<?php if(!empty($da)){echo $da->nome;}?>">
  </div>
</div>
        ...
        <div class="col-md-3">
   <div class="form-group">
     <label for="exampleInputEmail1">CNPJ <font color="red"><b>*</b></font></label>
    <input type="text" name="cn" class="form-control"  id= "cpf"value="<?php if(!empty($da)){echo $da->cnpj;}?>"  required>
  </div>
</div>   
   ...
   <div class="form-group">
    ...
    value="<?php if(!empty($da)){echo $da->telefone;}?>" class="form-control" id="tel" required>
  </div>
</div>
 ...
 <div class="col-md-2">
   <div class="form-group">
    ...
    <input type="text" name="cep" class="form-control cep"  required value="<?php if(!empty($da)){echo $da->cep;}?>">
  </div>
</div>
 ...
 <div class="col-md-4">
   <div class="form-group">
    ...
    <input type="text" name="estado" class="form-control" required data-cep="uf" value="<?php if(!empty($da)){echo $da->estado;}?>">
  </div>
</div>
...
<div class="col-md-4">
   <div class="form-group">
    ...
    <input type="text" name="cidade" class="form-control" required data-cep="cidade"  value="<?php if(!empty($da)){echo $da->cidade;}?>">
  </div>
</div>
...
<div class="col-md-4">
   <div class="form-group">
    ...
    <input type="text" name="bairro" class="form-control" required data-cep="bairro" value="<?php if(!empty($da)){echo $da->bairro;}?>">
  </div>
</div>
...
<div class="col-md-4">
   <div class="form-group">
    ...
    <input type="text" name="end" class="form-control" required data-cep="logradouro" value="<?php if(!empty($da)){echo $da->endereco;}?>">
  </div>
</div>
