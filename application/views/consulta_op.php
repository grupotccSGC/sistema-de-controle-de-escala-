...
<div class="container">
 <div class="row">
        ...
        <span class="glyphicon glyphicon-th" aria-hidden="true"></span> Consulta de Operações
        </h1>
      </div>
</div>
...
<?php echo form_open('Welcome/consulta_op',"class='form-inline'"); ?>
<input type="text" class="form-control" id="exampleInputName2" placeholder="Digite a descricao" name="busca" required>
...
<?php if($this->session->userdata('perfil')=='Gerente' || $this->session->userdata('perfil')=='Supervisor'){ ;?>
      ...
      <a href="<?php echo base_url('Welcome/edit_op/'.$a->id);?>" class="btn btn-primary">Editar <span class="glyphicon glyphicon-pencil"></span></a>
      </td>

      <td>
      <a href="<?php echo base_url('Welcome/excluir_op/'.$a->id);?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Excluir</a>
      </td>
        <?php }};?>
    </tr>
  </tbody>
