...
<div class="container">
 <div class="row">
        ...
        <span class="glyphicon glyphicon-th" aria-hidden="true"></span> Consulta de Funcionario
        </h1>
      </div>
</div>
...
<?php echo form_open('Welcome/consulta_fun',"class='form-inline'"); ?>
<input type="text" class="form-control" id="exampleInputName2" placeholder="Digite o nome do funcionario" name="busca" required>
...
<table class="table table-hover table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo $a->identidade; ?></td>
      <td><?php echo $a->cpf;?></td>
      <td><?php echo $a->cargo; ?></td>
      <td><?php echo $a->telefone;?></td>
      <td><?php echo $a->email;?></td>
      <?php if($this->session->userdata('perfil')=='Gerente' || $this->session->userdata('perfil')=='Supervisor'){ ;?>
      <td>
      <a href="<?php echo base_url('Welcome/edit_fu/'.$a->id);?>" class="btn btn-primary">Editar <span class="glyphicon glyphicon-pencil"></span></a>
      </td>

      <td>
      <a href="<?php echo base_url('Welcome/excluir_fu/'.$a->id);?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Excluir</a>
      </td>
      <?php }}; ?>
    </tr>
  </tbody>
